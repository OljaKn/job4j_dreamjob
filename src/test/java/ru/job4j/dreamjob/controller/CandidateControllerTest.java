...
class CandidateControllerTest {
    ...
    public void whenRequestCandidateCreationPageThenGetPageWithCities() {
        ...
        var expectedCandidates = model.getAttribute("cities");

        assertThat(view).isEqualTo("candidates/create");
        assertThat(expectedCandidates).isEqualTo(expectedCities);
    }
    ...
    @Test
    public void whenPostCandidateWithIdThenGetById() throws Exception {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var city1 = new City(1, "Москва");
        when(cityService.findAll()).thenReturn(List.of(city1));
        ...
        assertThat(actualCandidate).isEqualTo(candidate);
        assertThat(actualCities).isEqualTo(List.of(city1));
    }
    ...
    @Test
    public void whenDeleteCandidateByIdThenRedirectToCandidatesPage() {
